...
def attack(char_name: str, char_class: str) -> str:
    """Функция дает результат тренировок: атака."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция дает результат тренировок: защита."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция дает результат тренировок: спец навыки."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция дает пользователю выбрать действие для персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция дает пользователю выбрать персонажа."""
    approve_choice = None
    char_class = None
